package com.cortez.introkotlin903.practica3
...
class Ejemplo3Activity : AppCompatActivity() {
    ...
    fun controlar(view: android.view.View){
        ...
        if (valor==num){
            val notificacion= Toast.makeText(this,"Ganaste",Toast.LENGTH_LONG)
            notificacion.show()
        }else{
            val notificacion= Toast.makeText(this,"Perdiste",Toast.LENGTH_LONG)
            notificacion.show()
        }
    }
}